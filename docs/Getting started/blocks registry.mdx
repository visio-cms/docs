...
import MyFirstBlock from '@/components/blocks/MyFirstBlock.tsx';
...
## registeredBlocks Array Key Meanings
...
- **`defaultInputs`** - Default prop values that come with the block when initially added. This object matches the props of your block. In our example, we have `title`, `subTitle` and `image`.
...
We can start adding our block the a web page. Visit http://localhost:3000/builder/index. You have to login with your visio cms email and password.



For the first time opening the builder after login, you will be asked to create a page. Enter your page name and slug. **NB** `/index` is always your home page of your website.
