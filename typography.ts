  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links-hover': theme('colors.brand.green'),
        '--tw-prose-links-underline': theme('colors.brand.green / 0.3'),
        ...
        '--tw-prose-invert-links': theme('colors.brand.green'),
        '--tw-prose-invert-links-hover': theme('colors.brand.green'),
        '--tw-prose-invert-links-underline': theme('colors.brand.green / 0.3'),
