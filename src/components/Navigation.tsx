...
function ActivePageMarker({
  ...
  return (
    <motion.div
      layout
      className="absolute left-2 h-6 w-px bg-brand-green"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1, transition: { delay: 0.2 } }}
      exit={{ opacity: 0 }}
      style={{ top }}
...
export const navigation: Array<NavGroup> = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'Color', href: '/side-editing-color-controller'},
      { title: 'Image', href: '/side-editing-image-controller'},
      { title: 'Switch', href: '/side-editing-switch-controller'},
      { title: 'Radio group', href: '/side-editing-radio-group-controller'},
